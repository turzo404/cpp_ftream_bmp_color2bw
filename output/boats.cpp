...
char infile[]       =   "d:\\mitm302\\boats.bmp";
char outfile[]      =   "d:\\mitm302\\boats_bw.bmp";
char image_data[]   =   "d:\\mitm302\\boats_data.txt";
...
int main()
{
    ...
    while(!ifs.eof())
    {
        ...
        ofss<<"Boats.bmp: "<<(int)px.r<<", "<<(int)px.g<<", "<<(int)px.b<<"    "<<"Average: "<<(int)avg<<endl;
