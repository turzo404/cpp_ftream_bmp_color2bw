...
char infile[]       =   "d:\\mitm302\\pepper.bmp";
char outfile[]      =   "d:\\mitm302\\pepper_bw.bmp";
char image_data[]   =   "d:\\mitm302\\pepper_data.txt";
...
int main()
{
    ...
    while(!ifs.eof())
    {
        ...
        ofss<<"Pepper.bmp: "<<(int)px.r<<", "<<(int)px.g<<", "<<(int)px.b<<"    "<<"Average: "<<(int)avg<<endl;
